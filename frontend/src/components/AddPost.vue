<template>        
<h1>Новая статья</h1>
<Form @submit="handleAddPost" :validation-schema="schema" enctype="multipart/form-data">
...
<div class="form-group mb-3">
    ...
    <Field name="description" type="text" class="form-control" as="textarea"/>
    <ErrorMessage name="description" class="error-feedback" />
</div> 
<div class="form-group mb-3">
    <label for="content">Текст</label> 
    <Field name="content" type="text" class="form-control" id="content" v-slot="{field}">
        <editor v-bind="field"
            :init="{
            menubar: false,
            statusbar: false,
            ...
            toolbar: 'undo redo | styleselect fontsizeselect | forecolor backcolor | bold italic underline strikethrough | bullist numlist | blockquote | link image emoticons'
            }"
        />
    </Field>
...
<div class="form-group mb-3">
    ...
    <Field name="tag" class="form-control" as="select">
